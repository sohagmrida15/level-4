    ...
    <section class="cont">
        <div class="row logo">
            <div class="col-lg-4 logo_left">
                <?php the_custom_logo();?>
                <!-- <a href="#"><img src="<?=get_template_directory_uri();?>./assets/images/header/logo_bn.png" alt=""></a> -->
            </div>
    ...
    <section class="cont">
        <div class="row hero">
            <div class="hero_main col-lg-8">
                <div class="banner">
                    <a href="#"> <?php dynamic_sidebar('ban');?>
                    ...
                    <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
                        ...
                        ?>
                          ...
                          <!-- <div class="carousel-item">
                            <img src=" <?=get_template_directory_uri();?>./assets/images/slider/Banner-2.jpg" class="d-block w-100" alt="...">
                          </div>
            ...
            <div class="hero_side col-lg-4">
                <div class="side_img">
                    <a href="#"> <?php dynamic_sidebar('sideimg');?>
                        <img src=" <?=get_template_directory_uri();?>./assets/images/sidebar/bangladesh-    portal--batton-bangla.png" class="d-block w-100 mb-2" alt="">
                    </a>
                </div>
                <h4>সকল বাতায়ন</h4>
                <form action="">
